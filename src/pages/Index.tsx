          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-1 space-y-6">
              <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                ...
                <span className="text-primary">school administration</span>
              </h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our platform provides powerful tools for school administrators and
              teachers.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-blue-50 p-6 rounded-xl">
              ...
              <p className="text-gray-600">
                Get a complete overview of your school's operations with our
                intuitive dashboard.
              </p>
            </div>
            ...
            <div className="bg-blue-50 p-6 rounded-xl">
              ...
              <p className="text-gray-600">
                Easily manage your teaching staff, assign classes, and track
                performance.
              </p>
            </div>
            ...
            <div className="bg-blue-50 p-6 rounded-xl">
              ...
              <p className="text-gray-600">
                Gain insights into student performance, attendance, and school
                operations.
              </p>
            </div>
          </div>
      ...
      <footer className="bg-gray-900 text-white py-12 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="pt-8 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} SchoolSignup Central. All rights
              reserved.
            </p>
          </div>
        </div>
